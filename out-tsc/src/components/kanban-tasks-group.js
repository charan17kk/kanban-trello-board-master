...
let Header = class Header extends connect(store)(LitElement) {
    static get styles() {
        return [
            defaulCss,
            css `
    ...
    onDragStart(event) {
        console.log(event);
        let draggedTask = this.taskData.tasks.filter(item => item.id === event.target.id)[0];
          ...
          <div class="task-header">${this.taskData.title}</div>
            ...
            ? html `
                      <div class="task" draggable="false">
                        <div class="title">
                          <input type="text" .value="${this.newTaskData.heading}" @change=${(e) => this.onChangeTaskData(e, 'heading')} placeholder="Enter Title" />
                        </div>
                        <div class="description">
                        <input type="text" .value="${this.newTaskData.description}" @change=${(e) => this.onChangeTaskData(e, 'description')} placeholder="Enter Description" /></div>
                        <div class="actions">
    ...
    stateChanged(state) {
        const { reducer } = state;
        const { selectedBoard, boards } = reducer;
...
__decorate([
    property()
], Header.prototype, "taskData", void 0);
__decorate([
    property()
], Header.prototype, "addTaskStatus", void 0);
__decorate([
    property()
], Header.prototype, "newTaskData", void 0);
__decorate([
    property()
], Header.prototype, "selectedBoard", void 0);
__decorate([
    property()
], Header.prototype, "taskType", void 0);
__decorate([
    property()
], Header.prototype, "boards", void 0);
Header = __decorate([
    customElement('kanban-tasks-group')
], Header);
export { Header };
//# sourceMappingURL=kanban-tasks-group.js.map